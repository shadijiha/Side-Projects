...
public class Matrix {
	 ...
	 */
	public Matrix multiply(final Vec3D mat) {
	 ...
	 */
	public Vec3D toVector() throws Error {
		if (this.cols == 1) {
			if (this.rows == 1) {
				return new Vec3D(this.getData(0, 0), 0);
			} else if (this.rows == 2) {
				return new Vec3D(this.getData(0, 0), this.getData(1, 0));
			} else if (this.rows == 3) {
				return new Vec3D(this.getData(0, 0), this.getData(1, 0), this.getData(2, 0));
			} else {
