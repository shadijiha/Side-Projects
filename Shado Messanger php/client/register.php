...
<form action="register.php" method="post">
    <div id="login_panel">
        ...
        <br/>
        <br/>
        <input type="password" name="cpassword" id="confirm_password_input" required/>
        <br/>
        <br/>
        <span>Chossiez une couleur</span>
        <br/>
        <br/>
        <input type="color" name="color" id="color_input" required/>
        <br/>
        <br/>
...
if (isset($_POST['register_btn'])) {
    ...
    if ($password != $cpassword) {
        ...
        // Register user
        $user = RegisterUser($username, $password, $date, $color);
