...
public abstract class Util {
	...
	public static Color randomColor() {
		...
		return Color.from255(red, green, blue);
	}
	...
	public static Color randomColor(Color c) {
		...
		int red = (int) ((c.red * 255 + random(-20, 20)) % 255);
		int green = (int) ((c.green * 255 + random(-20, 20)) % 255);
		int blue = (int) ((c.blue * 255 + random(-20, 20)) % 255);
